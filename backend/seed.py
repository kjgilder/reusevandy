...
listings_data = [
    ...
    {
        "title": "IKEA Desk",
        "desc": "Sturdy white desk. Pick up only.",
        "price": 30.0,
        "category": Category.FURNITURE,
    },
    {
        "title": "Vanderbilt Hoodie",
    ...
    {
        "title": "Mini Fridge",
        "desc": "Perfect for dorm rooms. Works great.",
        "price": 50.0,
        "category": Category.ELECTRONICS,
    },
    {
        "title": "2x Football Tickets",
        "desc": "Student section for this Saturday's game.",
        "price": 20.0,
        "category": Category.TICKETS,
    },
    {
        "title": "Calculus Textbook",
        "desc": "Some highlights but very readable.",
        "price": 15.0,
        "category": Category.BOOKS,
    },
    {
        "title": "Standing Lamp",
        "desc": "Comes with a working bulb.",
        "price": 10.0,
        "category": Category.FURNITURE,
    },
    {
        "title": "Bluetooth Speaker",
        "desc": "Loud, clear sound. Comes with charging cable.",
        "price": 40.0,
        "category": Category.ELECTRONICS,
    },
    {
        "title": "Winter Coat",
        "desc": "Very warm, size L.",
        "price": 35.0,
        "category": Category.CLOTHING,
    },
    {
        "title": "Guitar",
        "desc": "Acoustic guitar in good shape. Great for beginners.",
        "price": 80.0,
    ...
    },
    {
        ...
        "desc": "1080p, HDMI cable included.",
        "price": 60.0,
        "category": Category.ELECTRONICS,
    },
    {
        "title": "Chair",
        "desc": "Comfortable rolling chair.",
        "price": 20.0,
        "category": Category.FURNITURE,
    },
    {
        "title": "Basketball",
        "desc": "Spalding indoor/outdoor.",
        "price": 15.0,
        "category": Category.OTHER,
    },
]
...
async def seed_db():
    ...
    await init_beanie(
        database=db, document_models=[User, Listing, Conversation, Message]
    )
    ...
    for _ in range(15):
        ...
        convo = await Conversation.find_one(
            Conversation.listing.id == listing.id, Conversation.buyer.id == buyer.id
        )

        if not convo:
            convo = Conversation(listing=listing, buyer=buyer, seller=listing.seller)
            await convo.insert()
    ...
    print(
        "Database seeded successfully with users, listings, conversations, and offers!"
    )
